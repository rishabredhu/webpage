...
const skills: Skill[] = [
  ...
  },
  {
    name: "Python",
    level: "Expert",
    projects: ["Data Analysis Pipeline", "Web Scraping Tool"],
  },
];
...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "An AI model that classifies images into predefined categories.",
      ...
      case "projects":
        if (args[0] === "--list") {
          ...
          const project = projects.find((p) =>
            p.name.toLowerCase().includes(args.join(" ")),
          );
          return project
            ? [
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="w-full max-w-2xl bg-gray-900 rounded-lg shadow-lg overflow-hidden">
        ...
        <form
          ...
          className="flex items-center px-4 py-2 bg-gray-800"
        >
