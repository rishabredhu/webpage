    ...
    <section className="bg-white-200 py-20 ">
      ...
      <div className="space-y-6 bg-white-700 dark:bg-white-700 p-6 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <p className="text-sm leading-relaxed pixelated">
          Hello! I&apos;m Rishab Singh, a passionate software engineer with a
          Masters in Science in Computer Science from New York University. With
          a strong foundation in computer science and years of hands-on
          experience spanning from academic research to industry applications,
          I&apos;ve honed my skills in delivering products and solutions that
          are both scalable and user-friendly.
        </p>
        <p className="text-sm leading-relaxed pixelated">
          My journey in tech has been diverse and fulfilling, allowing me to
          work on a wide range of projects. From building responsive web
          applications to creating intricate 3D visualizations, I&apos;m always
          excited about the intersection of technology and creativity.
        </p>
