        ...
        <section
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <main className="space-y-6">
              ...
              <div className="bg-white p-6 border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)]">
                <div className="h-28"> {/* Fixed height to maintain structure */}
                  <ReactTypingEffect
                    text={interestsText}
                    speed={50}
                    eraseSpeed={1}
                      ...
                      return (
                        <p className="text-justify">
                          {text.split(' ').map((word, i) => {
                            const key = `${i}`;
                            if (word === 'development,' || word === 'design,' || word === 'sports.') {
                              return <strong key={key} className="text-red-500">{word} </strong>;
                            }
              ...
              <div className="bg-white p-6 border-4 border-black shadow-[8px_8px_0px_rgba(0,0,0,1)]">
                <p className="text-sm leading-relaxed font-['Press_Start_2P'] text-justify">
                  ...
                  <span className="text-brown-500">Mylo</span>, in search for some good Coffee. Currently, I'm channeling my passion into building a startup and am always keen to connect with like-minded individuals. Feel free to {" "}
                  <a
