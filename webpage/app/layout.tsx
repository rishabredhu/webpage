...
export const metadata: Metadata = {
  ...
  description:
    "Explore the portfolio of Rishab Singh, a skilled software developer with six years of experience specializing in web development, AI, and data science.",
  keywords:
    "Rishab Singh, software developer, web development, AI, data science, portfolio",
  authors: [{ name: "Rishab Singh" }],
  openGraph: {
    title: "Rishab Singh - Portfolio",
    description:
      "Explore the portfolio of Rishab Singh, a skilled software developer specializing in web development, AI, and data science.",
